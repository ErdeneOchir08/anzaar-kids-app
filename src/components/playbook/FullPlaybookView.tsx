  ...
  return (
    <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8 space-y-8 print:p-0 print:m-0 print:max-w-none">
      ...
      <div id="playbook-printable-content" className="space-y-8 bg-white p-3 sm:p-8 rounded-[36px]">
        ...
        <div className="bg-gradient-to-br from-zinc-950 via-zinc-900 to-indigo-950 text-white rounded-[32px] p-6 sm:p-12 shadow-2xl relative overflow-hidden border border-zinc-800">
        ...
        <section className="bg-white rounded-3xl p-6 sm:p-10 border border-zinc-200/90 shadow-card space-y-5">
          <div className="flex items-center gap-3.5 pb-4 border-b border-zinc-100">
            <span className="w-10 h-10 rounded-2xl bg-indigo-50 text-indigo-700 font-black flex items-center justify-center text-sm border border-indigo-100">
              01
            </span>
            <div>
        ...
        <section className="bg-white rounded-3xl p-6 sm:p-10 border border-zinc-200/90 shadow-card space-y-6">
          <div className="flex items-center gap-3.5 pb-4 border-b border-zinc-100">
            <span className="w-10 h-10 rounded-2xl bg-rose-50 text-rose-700 font-black flex items-center justify-center text-sm border border-rose-100">
              02
            </span>
            <div>
              <h2 className="text-lg sm:text-xl font-black text-zinc-900">
        ...
        <section className="bg-white rounded-3xl p-6 sm:p-10 border border-zinc-200/90 shadow-card space-y-5">
          ...
          <div className="space-y-4">
            <div className="bg-zinc-50 p-5 rounded-3xl border border-zinc-200 space-y-2">
        ...
        <section className="bg-white rounded-3xl p-6 sm:p-10 border border-zinc-200/90 shadow-card space-y-5">
          <div className="flex items-center gap-3.5 pb-4 border-b border-zinc-100">
            <span className="w-10 h-10 rounded-2xl bg-emerald-50 text-emerald-700 font-black flex items-center justify-center text-sm border border-emerald-100">
              04
            </span>
            <div>
              <h2 className="text-lg sm:text-xl font-black text-zinc-900">
          ...
          <div className="space-y-4">
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div className="p-5 bg-emerald-50/60 rounded-3xl border border-emerald-200/70 space-y-2.5">
              ...
              <div className="p-5 bg-amber-50/60 rounded-3xl border border-amber-200/70 space-y-2.5">
        ...
        <section className="bg-white rounded-3xl p-6 sm:p-10 border border-zinc-200/90 shadow-card space-y-5">
          <div className="flex items-center gap-3.5 pb-4 border-b border-zinc-100">
            <span className="w-10 h-10 rounded-2xl bg-purple-50 text-purple-700 font-black flex items-center justify-center text-sm border border-purple-100">
              05
            </span>
            <div>
              <h2 className="text-lg sm:text-xl font-black text-zinc-900">
          ...
          <div className="space-y-3.5 text-xs sm:text-sm text-zinc-700 leading-relaxed">
            <p>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 pt-2">
              {archetype.parentingDos.map((pDo, i) => (
                <div key={i} className="p-4 bg-zinc-50 rounded-2xl border border-zinc-200 text-xs sm:text-sm text-zinc-800 flex items-start gap-2.5">
